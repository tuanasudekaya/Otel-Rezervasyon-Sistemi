...
{
    public partial class XtraFormYeniMusteri : DevExpress.XtraEditors.XtraForm
    {
        public XtraFormYeniMusteri()
        {
            InitializeComponent();
        }
        ...
        private void DtoCikisTar_EditValueChanged(object sender, EventArgs e)
        {
            int Ucret;
        ...
        private void XtraFormYeniMusteri_Load(object sender, EventArgs e)
        {
